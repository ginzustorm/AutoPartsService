...
namespace AutoPartsServiceWebApi.Migrations
{
    ...
    [Migration("20230508092003_AddNullableUserFields")]
    partial class AddNullableUserFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AutoPartsServiceWebApi.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Ivan Krisko",
                            PhoneNumber = "2443504",
                            RegistrationDate = new DateTime(2023, 5, 8, 19, 20, 3, 847, DateTimeKind.Local).AddTicks(429),
                            Role = 0
                        },
                        new
                        {
                            ...
                            Name = "John Green",
                            PhoneNumber = "5555678",
                            RegistrationDate = new DateTime(2023, 5, 8, 19, 20, 3, 847, DateTimeKind.Local).AddTicks(439),
                            Role = 1
                        });
                });
