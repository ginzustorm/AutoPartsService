...
namespace AutoPartsServiceWebApi.Migrations
{
    ...
    [Migration("20230708100414_BasedMig")]
    partial class BasedMig
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AutoPartsServiceWebApi.Models.Offer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AutoPartsServiceWebApi.Models.Offer", b =>
                {
                    b.HasOne("AutoPartsServiceWebApi.Models.Request", "Request")
                        .WithMany("Offers")
                        .HasForeignKey("RequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AutoPartsServiceWebApi.Models.UserCommon", "User")
                        .WithMany("Offers")
